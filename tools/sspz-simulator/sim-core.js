...
export const RECONSTRUCTION_PATHS = Object.freeze({
...
export function computeFanBeamComplementaryGeometry(rawParams, beta, options = {}) {
 ...
 */
export function computeAllCandidateAxialSpreadAtView(rawParams, directViewIndex, options = {}) {
  const p = validateParams(rawParams);
...
export function computeAllCandidateAxialSpreadSeries(rawParams, options = {}) {
  const p = validateParams(rawParams);
...
export function summarizeFinalCandidateContributions(candidatesInput) {
