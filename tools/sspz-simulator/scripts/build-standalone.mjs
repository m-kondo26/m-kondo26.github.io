...
const zffsResponse=stripExports(await readFile(new URL('../axial-domain.js',import.meta.url),'utf8'))+'\n'+stripExports(stripImports(await readFile(new URL('../zffs-response.js',import.meta.url),'utf8')));
