...
const stripImports = source => source.replace(/^import\s*\{[\s\S]*?\}\s*from\s*["']\.\/(?:sim-core|fdk-core|cba-core|detector-aperture|axial-response-core|zffs-geometry|zffs-response)\.js["'];\s*/gm, "");
